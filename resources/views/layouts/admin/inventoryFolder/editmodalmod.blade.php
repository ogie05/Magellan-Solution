...
<button class="btn btn-primary editBtn" data-bs-toggle="modal" data-bs-target="#editMod{{ $id }}"><i class="bi bi-pencil-square"></i></button>
                        
<!-- Modal -->
<div class="modal fade" id="editMod{{ $id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('modedit') }}" method="POST">
          @csrf
          <div class="modal-body">
            <input type="hidden" value="{{ $id }}" name="mod_id">
