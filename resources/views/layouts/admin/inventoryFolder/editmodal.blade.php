...
<button class="btn btn-primary editBtn" data-bs-toggle="modal" data-bs-target="#editBrand{{ $id }}"><i class="bi bi-pencil-square"></i></button>
                        
<!-- Modal -->
<div class="modal fade" id="editBrand{{ $id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('edit') }}" method="POST">
          ...
          <div class="modal-body">
            <input type="hidden" value="{{ $id }}" name="brand_id">
